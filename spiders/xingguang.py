...
ItemId = '71'  # 企鹅号-自媒体-腾讯开放内容平台
API_URL = 'http://120.79.137.205:9180/service.asmx/'
...
class XingGuangCrawl(object):  # YZ验证码
    ...
    def __init__(self):
        ...
        self.fp = open(os.path.join(defaults.DATA_PATH, defaults.FP_MAPS[XingGuangCrawl.name]),
                       'w', encoding='utf-8')
        ...
        while True:
            ...
            if phone_list:
                for phone in phone_list:
                    ...
                    phone_dict['source'] = XingGuangCrawl.name
                    # print(phone_dict)
