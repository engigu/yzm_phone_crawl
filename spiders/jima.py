...
ItemId = '6992'  # 企鹅号-自媒体-腾讯开放内容平台
API_URL = 'http://47.106.70.100:9180/service.asmx/'


class JiMaCrawl(object):  # YZ验证码
    name = 'jima'
    ...
    def __init__(self):
        ...
        self.fp = open(os.path.join(defaults.DATA_PATH, defaults.FP_MAPS[JiMaCrawl.name]),
                       'w', encoding='utf-8')
        ...
        while True:
            ...
            if phone_list:
                for phone in phone_list:
                    ...
                    phone_dict['source'] = JiMaCrawl.name
                    # print(phone_dict)
