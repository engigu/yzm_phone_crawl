...
ItemId = '1185'  # 百度
API_URL = 'http://www.maiziyzm.com:9180/service.asmx/'


class MaiZiYunCrawl(object):  # 麦子云验证码
    name = 'maiziyun'
    ...
    def __init__(self):
        ...
        self.fp = open(os.path.join(defaults.DATA_PATH, defaults.FP_MAPS[MaiZiYunCrawl.name]),
                       'w', encoding='utf-8')
        ...
        while True:
            ...
            if phone_list:
                for phone in phone_list:
                    ...
                    phone_dict['source'] = MaiZiYunCrawl.name
                    # print(phone_dict)
